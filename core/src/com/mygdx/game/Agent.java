...
public class Agent implements Comparable<Agent>{
    ...
    */
     ...
     */
    public Agent(String name, AgentType type, Statistics stats, List<Integer> skills, CurrentEquipment equipment, int texture, Boolean demented){
        //Assessment 4 change (S3)
        //added isDemented to instantiation
        this.name = name;
        this.type = type;
        this.stats = stats;
        this.skills = skills;
    ...
    //Assessment 4 change (S3)
    //added accessor and mutator for isDemented
